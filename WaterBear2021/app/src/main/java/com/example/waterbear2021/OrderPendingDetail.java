...
public class OrderPendingDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_pending_detail);

        mAuth = FirebaseAuth.getInstance();

        orderRecyclerView = findViewById(R.id.ordersPendingDetail_recyclerView);

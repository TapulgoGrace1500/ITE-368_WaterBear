...
public class Admin_Merchant_Adapter extends RecyclerView.Adapter<Admin_Merchant_Adapter.MerchantHolder> {

    private Context mContext;
    private ArrayList<StoresView> options;

    public Admin_Merchant_Adapter(Context mContext, ArrayList<StoresView> options) {

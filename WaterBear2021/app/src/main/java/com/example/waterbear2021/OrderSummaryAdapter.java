...
public class OrderSummaryAdapter extends RecyclerView.Adapter<OrderSummaryAdapter.CartHolder>{

    private Context mContext;
    private ArrayList<OrderDetail> options;

    public OrderSummaryAdapter(Context mContext, ArrayList<OrderDetail> options) {
        this.mContext = mContext;
        this.options = options;
    }

    @Override
    public void onBindViewHolder(@NonNull OrderSummaryAdapter.CartHolder holder, int position) {
        options.get(position);

        holder.prodName.setText(options.get(position).getOrderStoreName());
        ...
        holder.v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mContext,Buyer_Orders.class);
    ...
    @NonNull
    @Override
    public OrderSummaryAdapter.CartHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.order_detail_row, parent, false);
        return new OrderSummaryAdapter.CartHolder(v);
    }
    ...
    class CartHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener{
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
            menu.add(0,0,getAdapterPosition(),"Cancel Order");
